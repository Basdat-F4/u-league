...
from team.views import tes_daftar, get_team, reg_pelatih, reg_pemain, team, set_captain, delete_player, delete_coach, insert_pelatih, insert_pemain, register_team
