...
def get_team(request):
    ...
    with connection.cursor() as cursor:
        ...
        cursor.execute(f"""
    SELECT non_pemain.id_CONCAT(Non_Pemain.Nama_Depan, ' ', Non_Pemain.Nama_Belakang) AS Nama, Non_Pemain.Nomor_HP, Non_Pemain.Email, Non_Pemain.Alamat, Spesialisasi_Pelatih.Spesialisasi, Pelatih.Nama_Tim
FROM Pelatih
