...
from team.views import tes_daftar, get_team, reg_pelatih, reg_pemain, team, set_captain, delete_player, delete_coach
...
urlpatterns = [
    ...
    path('delete_coach/<uuid:pelatih_id>/', views.delete_coach, name='delete_coach'),
]
