    ...
    if request.method == 'POST':
        ...
        with connection.cursor() as cursor:
            ...
            if pelatih_info:
                ...
                error_message = 'Error: The coach already has the same specialization.'
                return reg_pelatih(request, error_message=error_message)  # Render the template with the error message
